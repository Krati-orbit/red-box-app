...
export default function AddBeneficiaryPage() {
    ...
    const { addBen } = useData()
    const { showToast } = useToast()
    const navigate = useNavigate()

    function touch(field, validator, ...args) {
        const msg = validator(...args)
    ...
    async function handleAdd(e) {
        ...
        await addBen({
            ...
            nomineeCondition, notes: notes.trim(),
        })
        showToast('✅ Beneficiary added & secured!')
        ...
        <div className="container" style={{ maxWidth: '640px' }}>
            <div className="page-header fade-up">
                <div>
                    ...
                    <div className="page-subtitle">All information is encrypted and stored securely</div>
                </div>
            ...
            <div className="alert alert-blue mb-6 fade-up">
                ...
                <div className="alert-text">
                    Information entered here is <strong>stored privately in your account</strong> and never shared.
                    The beneficiary receives access only after <strong>manual verification</strong>.
                </div>
            </div>
            ...
            <div className="card fade-up" style={{ padding: '0' }}>
                ...
                <form onSubmit={handleAdd} style={{ padding: '1.75rem' }}>
                    {/* ── TAB 1: BASIC INFO ── */}
                    {activeTab === 'basic' && (
                        <div>
                    ...
                    {activeTab === 'identity' && (
                        <div>
                            <div className="ben-form-identity-note mb-4">
                                <span>🔐</span>
                                <span>Identity details help verify the beneficiary. Visible only to you.</span>
                            </div>
                            <div className="form-group">
